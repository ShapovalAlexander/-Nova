(() => {
    ...
    function initSliders() {
        if (document.querySelector(".projects__slider")) {
            ...
            if (document.querySelector(".office__slider")) new swiper_core_Swiper(".office__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
    ...
    new Vivus("item-highlights-icon-01", {
        type: "delayed",
        duration: 100,
        animTimingFunction: Vivus.EASE
    });
    new Vivus("item-highlights-icon-02", {
        type: "delayed",
        duration: 100,
        animTimingFunction: Vivus.EASE
    });
    new Vivus("item-highlights-icon-03", {
        type: "delayed",
        duration: 100,
        animTimingFunction: Vivus.EASE
    });
    new Vivus("column-footer-brown__icon", {
        type: "delayed",
        duration: 200,
        animTimingFunction: Vivus.EASE
    });
